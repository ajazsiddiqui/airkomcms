    ...
    'access_filter' => [
        'controllers' => [
            Controller\UserController::class => [
                ...
                // to anyone.
                ['actions' => ['resetPassword', 'resetPasswordClient', 'message', 'setPassword'], 'allow' => '*'],
                // Give access to "index", "add", "edit", "view", "changePassword" actions to users having the "user.manage" permission.
                ['actions' => ['index', 'add', 'edit', 'setstatus'], 'allow' => '+user.manage'],
                ['actions' => ['view', 'edit-user'], 'allow' => '+profile.own.view'],
                ['actions' => ['changePassword'], 'allow' => '+password.manage'],
            ],
