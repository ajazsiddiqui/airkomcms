...
class AuthManager
{
    ...
    public const ACCESS_GRANTED = 1; // Access to the page is granted.
    public const AUTH_REQUIRED = 2; // Authentication is required to see the page.
    public const ACCESS_DENIED = 3; // Access to the page is denied.
