...
use Masters\Controller\CallTypeController;

class CallTypeControllerFactory implements FactoryInterface
{
    /**
    ...
    public function __invoke(ContainerInterface $container, $requestedName, array $options = null)
    {
        ...
        return new CallTypeController($authenticationService, $entityManager, $logManager);
    }
}
