...
use Masters\Controller\TravelModeController;

class TravelModeControllerFactory implements FactoryInterface
{
    /**
    ...
    public function __invoke(ContainerInterface $container, $requestedName, array $options = null)
    {
        ...
        return new TravelModeController($authenticationService, $entityManager, $logManager);
    }
}
