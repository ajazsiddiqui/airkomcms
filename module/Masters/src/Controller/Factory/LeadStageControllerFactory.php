...
use Masters\Controller\LeadStageController;

class LeadStageControllerFactory implements FactoryInterface
{
    /**
    ...
    public function __invoke(ContainerInterface $container, $requestedName, array $options = null)
    {
        ...
        return new LeadStageController($authenticationService, $entityManager, $logManager);
    }
}
