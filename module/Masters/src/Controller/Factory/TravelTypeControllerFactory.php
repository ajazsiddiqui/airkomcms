...
use Masters\Controller\TravelTypeController;

class TravelTypeControllerFactory implements FactoryInterface
{
    /**
    ...
    public function __invoke(ContainerInterface $container, $requestedName, array $options = null)
    {
        ...
        return new TravelTypeController($authenticationService, $entityManager, $logManager);
    }
}
