...
use Masters\Controller\NextActionController;

class NextActionControllerFactory implements FactoryInterface
{
    /**
    ...
    public function __invoke(ContainerInterface $container, $requestedName, array $options = null)
    {
        ...
        return new NextActionController($authenticationService, $entityManager, $logManager);
    }
}
