...
use Masters\Controller\SalesStageController;

class SalesStageControllerFactory implements FactoryInterface
{
    /**
    ...
    public function __invoke(ContainerInterface $container, $requestedName, array $options = null)
    {
        ...
        return new SalesStageController($authenticationService, $entityManager, $logManager);
    }
}
