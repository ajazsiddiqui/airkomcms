...
use Settings\Controller\TargetsController;

class TargetsControllerFactory implements FactoryInterface
{
    /**
    ...
    public function __invoke(ContainerInterface $container, $requestedName, array $options = null)
    {
        ...
        return new TargetsController($dir, $authenticationService, $entityManager, $logManager);
    }
}
